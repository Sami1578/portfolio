...
function ProjectsEdit({ project }) {
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Edit Project", children: [
    /* @__PURE__ */ jsx(PageHeader, { eyebrow: "Projects", title: "Edit project", description: project.title }),
    /* @__PURE__ */ jsx(ProjectForm, { project })
  ] });
}
export {
